...
const DiscountsModal = ({ mode, show, handleClose, editDiscountFormData }) => {
  const [discountsFormData, setDiscountsFormData] = useState({
    name: '',
    nightsDiscountMapping: {},
    discountType: 'PerNight'
  });
    ...
    return (
      <>
        <DropdownButton id="dropdown-basic-button" title="Actions" size="sm">
          <Dropdown.Item onClick={(e) => editDiscount(params.value)} >Edit</Dropdown.Item>
          <Dropdown.Item onClick={(e) => deleteDiscount(params.value)} >Delete</Dropdown.Item>
        </DropdownButton>
      </>
    );
  };
        ...
        <Col lg={7} md={12} sm={12}>
          <Card>
            <Card.Body>
              ...
              <DiscountsModal mode={mode} show={show} handleClose={handleClose} editDiscountFormData={editDiscountFormData} />
            </Card.Body>
          </Card>
        </Col>
      </Row>
