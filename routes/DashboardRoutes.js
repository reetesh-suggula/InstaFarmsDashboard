...
export const DashboardMenu = [
	...
	// },
	{
		...
		icon: 'map-pin',
		children: [
			{ id: uuid(), link: '/locations/states', name: 'States' },
			{ id: uuid(), link: '/locations/cities', name: 'Cities' },
			{ id: uuid(), link: '/locations/areas', name: 'Areas' },
		]
	},
	{
		id: uuid(),
	...
	},
	{
		...
		icon: 'percent',
		children: [
			{ id: uuid(), link: '/discounts/discountsPerNight', name: 'Discounts Per Night' },
			{ id: uuid(), link: '/discounts/lastminuteDiscount', name: 'Last Minute Discount' },
		]
	},
	{
		id: uuid(),
